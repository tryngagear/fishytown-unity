...
public class CloudMaster : MonoBehaviour
{
    ...
    private void OnRenderImage(RenderTexture src, RenderTexture dest) {
        ...
        var noise = FindObjectOfType<NoiseGen>();
        noise.UpdateNoise();
        ...
        material.SetTexture("_MainTex", src);//create scriptable render pass to replace blit
    ...
    void SetDebugParams() {
        ...
        if (noise.viewerEnabled) {
            debugModeIndex = (noise.activeTextureType == NoiseGen.CloudNoiseType.Shape) ? 1 : 2;
        }
