...
inline void InitializePSXVertLitSurfaceData(float2 uv, float ir, out SurfaceData outSurfaceData){
    outSurfaceData = (SurfaceData)0;
    half4 albedoAlpha = SampleAlbedoAlphaPSX(uv, ir, TEXTURE2D_ARGS(_BaseMap, sampler_BaseMap));
